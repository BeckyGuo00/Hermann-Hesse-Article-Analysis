...
source = "https://www.gutenberg.org/ebooks/74222"
...
"""
tei_body = "<text>"
with open (r"Project\plain_text_hesse\demian.txt", encoding = "utf8") as input:
    ...
    soup = bs(tei, "xml")
    with open(r"Project\plain_text_hesse\demian.tei", "w", encoding = "utf8") as output:
