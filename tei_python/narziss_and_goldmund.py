...
source = "https://archive.org/details/dli.ernet.236666/page/n79/mode/2up"
...
"""
tei_body = "<text>"
with open (r"Project\plain_text_hesse\narziss_and_goldmund.txt", encoding = "utf8") as input:
    ...
    soup = bs(tei, "xml")
    with open(r"Project\plain_text_hesse\narziss_and_goldmund.tei", "w", encoding = "utf8") as output:
