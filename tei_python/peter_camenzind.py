...
source = "https://s3.us-west-1.wasabisys.com/luminist/EB/H/Hesse%20-%20Peter%20Camenzind.pdf"
...
"""
tei_body = "<text>"
with open (r"Project\plain_text_hesse\peter_camenzind.txt", encoding = "utf8") as input:
    ...
    soup = bs(tei, "xml")
    with open(r"Project\plain_text_hesse\peter_camenzind.tei", "w", encoding = "utf8") as output:
