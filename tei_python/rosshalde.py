...
source = "https://s3.us-west-1.wasabisys.com/luminist/EB/H/Hesse%20-%20Rosshalde.pdf"
...
"""
tei_body = "<text>"
with open (r"Project/plain_text_hesse/rosshalde.txt", encoding = "utf8") as input:
    ...
    soup = bs(tei, "xml")
    with open(r"Project/plain_text_hesse/rosshalde.tei", "w", encoding = "utf8") as output:
