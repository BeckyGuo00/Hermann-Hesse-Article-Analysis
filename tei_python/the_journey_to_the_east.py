...
source = "https://archive.org/details/in.ernet.dli.2015.247218/page/n95/mode/2up"
...
"""
tei_body = "<text>"
with open (r"Project\plain_text_hesse\the_journey_to_the_east.txt", encoding = "utf8") as input:
    ...
    soup = bs(tei, "xml")
    with open(r"Project\plain_text_hesse\the_journey_to_the_east.tei", "w", encoding = "utf8") as output:
